...
// in flutter_foundations/test/features/home/presentation/bloc/home_user_bloc_test.dart.
...
class MockGetUserUseCase extends _i1.Mock implements _i4.GetUserUseCase {
  ...
  @override
  _i5.Future<_i3.User> call(String? userId) =>
      (super.noSuchMethod(
            Invocation.method(#call, [userId]),
            returnValue: _i5.Future<_i3.User>.value(
              _FakeUser_1(this, Invocation.method(#call, [userId])),
            ),
          )
